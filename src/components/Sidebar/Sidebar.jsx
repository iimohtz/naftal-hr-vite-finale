...
const EmployeesIcon = () => (
  <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
    <circle cx="6.5" cy="5" r="3" stroke="currentColor" strokeWidth="1.5" />
    <path
      d="M1 15c0-3.038 2.462-5.5 5.5-5.5S12 11.962 12 15"
      stroke="currentColor"
      strokeWidth="1.5"
      strokeLinecap="round"
    />
    <path
      d="M12.5 8a2.5 2.5 0 100-5M17 15c0-2.485-1.902-4.5-4.25-4.5"
      stroke="currentColor"
      strokeWidth="1.5"
      strokeLinecap="round"
    />
...
const DocumentIcon = () => (
  <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
    <path
      d="M10 1H4a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V6l-6-5z"
      stroke="currentColor"
      strokeWidth="1.5"
      strokeLinejoin="round"
    />
    <path
      d="M10 1v5h5M6 10h6M6 13h4"
      stroke="currentColor"
      strokeWidth="1.5"
      strokeLinecap="round"
    />
...
const SettingsIcon = () => (
  <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
    <path d="M7.5 1.5h3l.5 2a5.5 5.5 0 011.2.7l1.9-.8 2.1 2.1-.8 1.9c.3.4.5.8.7 1.2l2 .5v3l-2 .5a5.5 5.5 0 01-.7 1.2l.8 1.9-2.1 2.1-1.9-.8c-.4.3-.8.5-1.2.7l-.5 2h-3l-.5-2a5.5 5.5 0 01-1.2-.7l-1.9.8-2.1-2.1.8-1.9a5.5 5.5 0 01-.7-1.2l-2-.5v-3l2-.5c.2-.4.4-.8.7-1.2l-.8-1.9 2.1-2.1 1.9.8c.4-.3.8-.5 1.2-.7l.5-2z" stroke="currentColor" strokeWidth="1.4" strokeLinejoin="round"/>
...
export default function Sidebar() {
  ...
  const avatarInitial = (currentUser?.firstName || currentUser?.name || "?")
    .charAt(0)
    .toUpperCase();

  // ── Sub-label under name: position title ──────────────────────
  const roleLabel =
    currentUser?.position || currentUser?.badge || currentUser?.role || "";
